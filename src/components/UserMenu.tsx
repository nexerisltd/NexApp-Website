...
import { ChevronDown, Heart, LayoutDashboard, LayoutList, Shield, UploadCloud, User as UserIcon } from "lucide-react";
            ...
            {open && (
              ...
              >
                ...
                <Link
                  ...
                  className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-surface-2"
                >
                  <Heart size={14} className="text-text-muted" /> Favorites
                </Link>
                <Link
                  href="/downloads"
                  onClick={() => setOpen(false)}
                ...
                {!isAdmin && (
                  <>
                    <Link
                      ...
                      className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-surface-2"
                    >
                      <UploadCloud size={14} className="text-text-muted" /> Submit an app
                    </Link>
                    <Link
                      href="/dashboard"
                      onClick={() => setOpen(false)}
                      className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-surface-2"
                    >
                      <LayoutList size={14} className="text-text-muted" /> Developer Dashboard
                    </Link>
                  </>
                )}
                {isAdmin && (
